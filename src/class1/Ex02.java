...
public class Ex02 {
	...
	public static void main(String[] args) {
		...
		rectangle.printRectangle(); // 가로길이0, 세로길이0
		...
		rect1.printRectangle(); // 가로길이10, 세로길이8
		rect1.width = 30;
		
		rect1.printRectangle(); // 가로길이30, 세로길이8
		rectangle.printRectangle(); // 가로길이30, 세로길이8   이게 신기
		
		rect1 = new Rectangle();
		rect1.printRectangle(); // 가로길이0, 세로길이0
		rectangle.printRectangle(); // 가로길이30, 세로길이8
		...
		rectangles[30].printRectangle(); // 가로길이0, 세로길이0
